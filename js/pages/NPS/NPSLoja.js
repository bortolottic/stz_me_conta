...
class NPSLoja extends React.Component {
	...
	render() {
		...
		if(this.state.npsTableData) {
			table = <CustomTable _onRowClick={(props) => {this.handleTableClick(props)}} id="table1" data={this.state.npsTableData}></CustomTable>;
		} else {
