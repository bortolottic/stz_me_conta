...
class TMRLoja extends React.Component {
	...
	render() {
		...
		if(this.state.tableData) {
			table = <CustomTable id="table1" _onRowClick={(props) => {this.handleTableClick(props)}}  data={this.state.tableData}></CustomTable>;
		}
